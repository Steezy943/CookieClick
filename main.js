...
Game.Launch=function()
{
	...
	css.type='text/css';
	css.innerHTML='body .icon,body .crate,body .usesIcon{background-image:url(https://unblokedgames.github.io/projects/cookie-clicker/img/icons.png?v='+Game.version+');}';
	...
	Game.Load=function()
	{
		...
		Game.Loader.domain='https://unblokedgames.github.io/projects/cookie-clicker/img/';
		Game.Loader.loaded=Game.Init;
		Game.Loader.Load(['empty.png']);
	}
